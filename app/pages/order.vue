<template>
    <div class="flex justify-center items-center bg-[#FFFFF6] text-[#333333]">
        <div
            class="flex flex-col items-start w-[800px] sm:mt-[128px] p-[32px] rounded-12px relative"
        >
            ...
            ></div>
            <button class="self-end mb-[16px] z-1">
                <CloseIcon />
            </button>
            <div class="sm:grid sm:grid-cols-2 gap-[32px] w-full">
                ...
                <div class="flex flex-col gap-[32px] pt-[140px] sm:pt-0">
                    <div class="flex flex-col justify-center">
                        <h2 class="z-1">Lomito con pimentón</h2>
                        <p class="text-[#858589]">
                    ...
                    >
                        <div class="flex justify-between items-center">
                            <div class="flex flex-col gap-[8px]">
                                <h5 class=""><strong>3 productos</strong></h5>
